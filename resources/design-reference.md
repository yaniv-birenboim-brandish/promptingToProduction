...
ThemeForest item 3057579), studied from a locally saved copy of the public
masonry preview.

**What this file is:** design *direction* — tokens, layout rules, and
interaction patterns described in our own terms, for building FamAlbum's UI.
**What it is not:** the template's markup, CSS, or images. Those are a licensed
commercial product. Nothing here should be implemented by pasting their code;
if you want the actual files, buy the template and the license covers you.
...
`resources/design-reference-source.png` is a screenshot of the saved preview, kept
for orientation while building. It's a reference image, not an asset — don't
ship it.
